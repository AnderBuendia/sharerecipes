 ...
 * - Number of characters must be between 3 to 26
 * @param value Value to validate
 * @returns Is valid
 */
export const usernameValidation = (value: string) => {
  const userName = value.trim();
  const regex = /^(?=[a-zA-Z0-9._]{3,26}$)(?!.*[_.]{2})[^_.].*[^_.]$/;
 ...
 * - Only contains alphanumeric characters and whitespaces
 * - Number of characters must be between 3 to 64
 * @param value Value to validate
 * @returns Is valid
 */
export const recipeNameValidation = (value: string) => {
