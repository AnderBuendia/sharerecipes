    ...
    return (
        <div className="w-full text-black bg-gray-400 dark-mode:text-gray-200 dark-mode:bg-gray-800">
            <div className="flex flex-col px-4 mx-auto md:items-center md:justify-between md:flex-row">
                ...
                <SearchBar className="bg-white placeholder-gray-700 h-10 px-4 md:pr-40 py-4 rounded-full text-sm focus:outline-none" />
                ...
                { userData !== null ?
                    <>
                        <Link href="/newrecipe">
                            <a className="flex-1 bg-green-800 px-3 py-2 mr-5 rounded-lg text-white font-bold uppercase border-b-2 border-r-2 
